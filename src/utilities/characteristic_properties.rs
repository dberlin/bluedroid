use esp_idf_sys::{ESP_GATT_CHAR_PROP_BIT_AUTH, ESP_GATT_CHAR_PROP_BIT_BROADCAST, ESP_GATT_CHAR_PROP_BIT_EXT_PROP, ESP_GATT_CHAR_PROP_BIT_INDICATE, ESP_GATT_CHAR_PROP_BIT_NOTIFY, ESP_GATT_CHAR_PROP_BIT_READ, ESP_GATT_CHAR_PROP_BIT_WRITE, ESP_GATT_CHAR_PROP_BIT_WRITE_NR, esp_gatt_char_prop_t};
use log::warn;
